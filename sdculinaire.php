...
et les enregistre dans la session |Chatodit 29-04  */
  ...
  $theme = 'Culinaire';
  $requete_question = $bdd->query('SELECT * FROM sondage WHERE theme=\'Culinaire\'');
  ...
  if ($_SERVER['REQUEST_METHOD'] == "POST") {
      ...
      // Insertion des valeurs dans la base de donnée | Romain 02-05
...
<head>
	...
	<body>
      ...
      <h1 class="h1_question">Theme : Culinaire</h1>
        <br>
      <?php 
      $x = 0;
